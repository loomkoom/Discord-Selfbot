    ...
    async def servershare(self, ctx, *, num_servers):
        ...
        if " | server=" in num_servers:
            try:
                ...
                await self.bot.send_message(ctx.message.channel, self.bot.bot_prefix + "Wrong format")
                return
            ...
            try:
                ...
                await self.bot.send_message(ctx.message.channel, self.bot.bot_prefix + "The argument isnt an integer")
